...
Route::post('/cash-bank/accounts', [CashBankController::class, 'storeAccount'])->name('cash-bank.accounts.store');
Route::put('/cash-bank/accounts/{code}', [CashBankController::class, 'updateAccount'])->name('cash-bank.accounts.update');
Route::patch('/cash-bank/accounts/{code}/status', [CashBankController::class, 'accountStatus'])->name('cash-bank.accounts.status');
Route::post('/cash-bank/accounts/{code}/adjust-balance', [CashBankController::class, 'adjustBalance'])->name('cash-bank.accounts.adjust');
Route::get('/cash-bank/accounts/{code}/activity', [CashBankController::class, 'activity'])->name('cash-bank.accounts.activity');
Route::post('/cash-bank/transactions', [CashBankController::class, 'storeTransaction'])->name('cash-bank.transactions.store');
Route::post('/cash-bank/transactions/{identifier}/reverse', [CashBankController::class, 'reverseTransaction'])->name('cash-bank.transactions.reverse');
Route::post('/cash-bank/reconciliations', [CashBankController::class, 'reconcile'])->name('cash-bank.reconciliations.store');
Route::get('/expenses', [ExpenseController::class, 'index'])->name('expenses');
Route::get('/expenses/export/csv', [ExpenseController::class, 'csv'])->name('expenses.export.csv');
Route::post('/expenses', [ExpenseController::class, 'store'])->name('expenses.store');
Route::put('/expenses/{expenseNumber}', [ExpenseController::class, 'update'])->name('expenses.update');
Route::post('/expenses/{expenseNumber}/submit-review', [ExpenseController::class, 'submitForReview'])->name('expenses.submit-review');
Route::post('/expenses/{expenseNumber}/approve', [ExpenseController::class, 'approve'])->name('expenses.approve');
Route::delete('/expenses/{expenseNumber}', [ExpenseController::class, 'destroy'])->name('expenses.destroy');
...
Route::get('/tax-settings/summary', [TaxSettingController::class, 'summary'])->name('tax-settings.summary');
Route::get('/tax-settings/export/csv', [TaxSettingController::class, 'csv'])->name('tax-settings.export.csv');
Route::post('/tax-settings', [TaxSettingController::class, 'store'])->name('tax-settings.store');
Route::put('/tax-settings/{id}', [TaxSettingController::class, 'update'])->name('tax-settings.update');
Route::patch('/tax-settings/{id}/status', [TaxSettingController::class, 'status'])->name('tax-settings.status');
Route::post('/tax-settings/{id}/default', [TaxSettingController::class, 'setDefault'])->name('tax-settings.default');
