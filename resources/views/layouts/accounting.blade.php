    ...
    <div id="app-shell" class="min-h-screen lg:pl-60 print:pl-0">
        ...
        <aside id="app-sidebar" class="fixed inset-y-0 left-0 z-30 hidden h-dvh w-60 flex-col overflow-hidden bg-[#0f172a] text-slate-300 lg:flex print:hidden" aria-label="Primary navigation">
            ...
            <nav class="dashboard-scrollbar-hidden min-h-0 flex-1 overflow-y-auto px-2 py-3 text-[12.5px]">
                ...
                <button type="button" title="General Ledger" class="apm-nav-item"><span class="apm-nav-content"><i class="apm-nav-icon fa-solid fa-book-open" aria-hidden="true"></i><span class="apm-nav-label">General Ledger</span></span><span class="apm-nav-badge apm-full-badge">FULL</span></button>
                ...
                <button type="button" title="Accounts Payable" class="apm-nav-item"><span class="apm-nav-content"><i class="apm-nav-icon fa-solid fa-money-check-dollar" aria-hidden="true"></i><span class="apm-nav-label">Accounts Payable</span></span><span class="apm-nav-badge apm-full-badge">FULL</span></button>
